...
output_file = os.path.join(base_dir, "output", "pa_roads_only2_tiles_z17.txt")
...
print("Computing tiles at zoom 17...")
for geom in gdf.geometry:
    if geom is None:
        continue
    bounds = geom.bounds  # (minx, miny, maxx, maxy)
    for tile in mercantile.tiles(bounds[0], bounds[1], bounds[2], bounds[3], zooms=[17]):
